		 ...
		 try {
			    ResultSet result= conn.createStatement().executeQuery(query);
				  ...
				  {  
					...
					// Ruben souviens toi que une query dans une query tu l'as pas tester si ̤a bug ici reporte ce qu'il y'a ici un peu plus bas et passe les donn̩ par user
					  // si enseignant 
					  ...
					  // le met en tant qu'̩tudiant si s'en est un 
					  try {
